  ...
  es: {
    ...
    popup: {
      ...
      ohanaSummary: {
        ...
        clean: 'Esta {type} es saludable para tu configuración. ',
        done: 'Hemos creado {edits} filter{s} para que este {type} sea saludable para tu configuración',
    ...
    ohana_tv_experience_will: 'La experiencia de Ohana TV se ajustará a tu configuración.',
    see_tour: 'Ver recorrido',
    define_your: 'Define tu',
    settings_l: 'ajustes',
    to_see_this_section: 'para ver esta sección.',
    no_titles_found_matching: 'No se encontraron títulos que coincidan con tu configuración.',
